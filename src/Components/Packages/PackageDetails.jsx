...
const PackageDetails = () => {
  ...
  return (
    <div className="my-12 mx-4">
      <h1 className="text-2xl text-center bg-slate-900 p-3 text-white font-semibold mb-6">{title}</h1>
      <div className="flex flex-col-reverse lg:flex-row justify-between gap-3">
        <div className="w-full lg:w-3/4">
          <p className="text-justify text-xl mb-6 bg-slate-300 p-4">{description}</p>
      ...
      <div className="flex justify-center mt-12">
        <Link className="bg-slate-900 hover:bg-slate-700 px-6 py-2 text-white" to='/'>Back</Link>
      </div>
    </div>
  );
};
